...
@Component
public class RefundListDetailCommand  implements Command  {
	...
	public void execute(Model model) {
		...
		String tuition_index = request.getParameter("tuition_index");
		List<Tuition_refundDto> RefundListDetail = tuitionDao.RefundListDetail(tuition_index);

		model.addAttribute("RefundListDetail", RefundListDetail);
