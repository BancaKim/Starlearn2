	...
	<main style="margin: 100px auto 0;">
		<div class="one-main">
			...
			<div class="card d-flex flex-row mx-auto w-80 parent">
				<img style="width: 170px; height: 250px; border-radius: 15px;"
					src="${pageContext.request.contextPath}/resources/images/courseDefaultImate.jpg"
					alt="Placeholder Image">
					
				<div class="card-body">
					<h5 class="card-title">보험대리점 보수교육</h5>
					<p> </p>
					<p>보험 판매 유자격자의 보험판매 자격 유지를 위한 보수 교육</p>
					<p>기타국내기관 | 30일</p>
					<p style="padding-top: 0px; color: #84888b;">연수기간 20240602~20240608</p>
					<p style="padding-top: 0px; color: #84888b;">신청기간 20240602~20240608</p>
				...
				<div class="child">
					...
					<button
						style="padding-left: 20px; text-align: center; line-height: 50px; width: 100px; height: 50px; background-color: #d3d3d3; border-radius: 5px;"
						class="accordion-button" type="button" data-bs-toggle="collapse"
						data-bs-target="#collapseContent" aria-expanded="false"
						aria-controls="collapseContent">연수 신청</button>
				</div>
			</div>
